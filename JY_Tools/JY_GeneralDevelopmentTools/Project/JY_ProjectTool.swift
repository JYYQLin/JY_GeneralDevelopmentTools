...
public final class JY_ProjectTool { // 核心修改1：添加@objc，保证OC混编兼容
    ...
    @objc public static func getAppName() -> String { // 核心修改2：所有对外方法加@objc public
    ...
    @objc public static func getProjectName() -> String {
    ...
    /// - 非标准版本号返回0
    /// - Returns: 版本号对应的Int值
    @objc public static func appVersionToInt() -> Int {
    ...
    @objc public static func getBuildVersion() -> String {
    ...
    @objc public static func getVersionAndBuildString() -> String {
    ...
    @objc public static func getDocumentsPath() -> String {
...
public extension JY_ProjectTool {
    /// 1. 是否是调试版（Debug）
    @objc static func isDebugMode() -> Bool {
#if DEBUG
        return true
#else
        return false
    ...
    @objc static func isTestFlightVersion() -> Bool {
        let receiptURL = Bundle.main.appStoreReceiptURL
        return receiptURL?.path.contains("sandboxReceipt") ?? false
    }
    
    /// 3. 是否是App Store正式版
    @objc static func isAppStoreVersion() -> Bool {
        !isDebugMode() && !isTestFlightVersion() && !isJailbroken()
    }
    
    /// 4. 是否是模拟器（适配调试）
    @objc static func isSimulator() -> Bool {
...
public extension JY_ProjectTool {
    ...
    @objc public static func isFirstLaunch() -> Bool {
        ...
        // 优化：移除synchronize()，iOS10+已废弃，系统会自动同步UserDefaults
        return true
    }
...
public extension JY_ProjectTool {
    ...
    /// - Returns: 是否低于目标版本
    @objc static func isCurrentVersionLowerThan(_ targetVersion: String) -> Bool {
    ...
    @objc static func getAppLanguage() -> String {
    ...
    @objc static func getRegion() -> String {
