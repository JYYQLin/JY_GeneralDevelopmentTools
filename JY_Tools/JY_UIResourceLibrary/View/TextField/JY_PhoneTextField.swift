...
class JY_PhoneTextField: JY_View {
    ...
    private lazy var yq_placeholder: String = "请输入你的手机号码"
...
extension JY_PhoneTextField {
    override func layoutSubviews() {
        ...
        yq_textField.frame.origin = {
            ...
            yq_textField.keyboardType = .phonePad
            
            yq_textField.textColor = UIColor.color424242
            yq_textField.placeholderColor = UIColor.colorBDBDBD
